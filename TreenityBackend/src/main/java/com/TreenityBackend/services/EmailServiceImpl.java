        ...
        String htmlContent = """
            <div style="font-family: Arial, sans-serif; line-height: 1.6; padding: 20px; max-width: 600px; margin: auto; border: 1px solid #ddd; border-radius: 10px; position: relative;">
                ...
                <div style="text-align: center; margin-top: 20px;">
                    ...
                    <a href="https://www.cascinacaccia.net" style="display: inline-block; margin: 10px; padding: 10px 20px; color: white; background-color: #f70084; text-decoration: none; border-radius: 5px;">Vai al portale</a>
                </div>
